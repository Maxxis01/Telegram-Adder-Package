...
def update_tool():
	...
	banner()
	source = r.get("https://github.com/daredevilkinng/Telegram-Adder-Package.git")
	if source.text == '3':
		...
		os.system("""
			curl -s -O https://github.com/daredevilkinng/Telegram-Adder-Package/blob/master/groupadd.py
			curl -s -O https://github.com/daredevilkinng/Telegram-Adder-Package/blob/master/scraper.py
			curl -s -O https://github.com/daredevilkinng/Telegram-Adder-Package/blob/master/setup.py
			curl -s -O https://github.com/daredevilkinng/Telegram-Adder-Package/blob/master/smsbot.py
			chmod 777 *.py
			""");time.sleep(1)
